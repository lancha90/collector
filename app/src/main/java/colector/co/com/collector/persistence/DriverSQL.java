...
//			super(context, "/storage/sdcard0/DB_DMS_MOBILE.db", factory, AppSettings.DB_VERSION);
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.execSQL("create table if not exists TBL_RESPONSE_COMPLEX_OPTION ( ID  INTEGER , LABEL  TEXT, VALUE  TEXT,TYPE  INTEGER, COMPLEX  INTEGER );");
			...
			db.execSQL("CREATE TABLE IF NOT EXISTS TBL_SURVEY_INSTANCE ( ID  INTEGER PRIMARY KEY AUTOINCREMENT, ID_SURVEY  INTEGER, DATE_INSTANCE  TEXT,LATITUDE  TEXT,LONGITUDE  TEXT,STATUS TEXT NOT NULL DEFAULT 'FALSE');");
