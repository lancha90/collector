...
//			super(context, "/storage/sdcard0/DB_DMS_MOBILE.db", factory, AppSettings.DB_VERSION);
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.execSQL("CREATE TABLE IF NOT EXISTS TBL_SURVEY_INSTANCE ( ID  INTEGER PRIMARY KEY AUTOINCREMENT, ID_SURVEY  INTEGER, DATE_INSTANCE  TEXT,LATITUDE  TEXT,LONGITUDE  TEXT);");
